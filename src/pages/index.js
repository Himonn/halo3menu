...
const Home = () => {
    ...
    const [backgrounds, setBackgrounds] = useState(['bg_0_hd.mp4', 'bg_chief_arbiter_hd.mp4', 'bg_chief_elite.mp4', 'bg_starship_hd.mp4', 'bg_warthog_hd.mp4', 'mp_bg.mp4']);
    ...
    return (
        <div className="relative">
            ...
            <MenuContainer setBackgroundIndex={setIndex} />
            <TitleLogoContainer />
        </div>
    );
};
